...
> Modified by satellitedown for Cinference: portable reproduction commands and provenance labeling.
> The measurements below are retained upstream NInfer results, not Cinference MTP-10 results.
...
```bash
export NINFER_BENCH_PYTHON=python3.11
```
