...
> Modified by satellitedown for Cinference: build guidance refers to the selected fork revision.
...
and Qwen3.6-35B-A3B groupwise-int. Check out the Cinference revision you intend to use and
[rebuild the engine](../README.md#quick-start), then run with Python 3.11:
