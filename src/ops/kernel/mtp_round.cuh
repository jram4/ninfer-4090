// Modified by satellitedown for Cinference: document the extended K=1..10 MTP round contract.
// See NOTICE and upstream-provenance.json for upstream attribution.

#pragma once

// Implements: include/ninfer/ops/mtp_round.h
// Match: request-major fixed K=1..10 autoregressive MTP round transition.
